...
export class AddImageToTopic1650095581392 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`topics\` ADD CONSTRAINT \`FK_6bbf40502d57cc3b9357d6c915d\` FOREIGN KEY (\`image_id\`) REFERENCES \`files\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
    }
